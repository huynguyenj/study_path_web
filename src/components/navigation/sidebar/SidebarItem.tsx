...
export default function SidebarItem({ name, path, icon: Icon }: SidebarItemProps) {
  return (
    <NavLink to={path} className={({ isActive }) => 
              `flex gap-2 px-5 py-3 mb-2 items-center hover:bg-[#e7eff7] hover:border-r-[#1D89EA] dark:hover:bg-[rgba(152,47,140,0.36)] dark:hover:border-r-[rgba(159,31,144,1)] cursor-pointer rounded-2xl hover:border-r-[5px] 
